...
public class shipManager : MonoBehaviour
{
    ...
    private void Update()
    {
        if (GameManager.Instance.cockpitBoostOn == false && _oxygenGardenState.arePlantsWatered() == false && _oxygenGardenState.areAllPlantsBlank() == true && GameManager.Instance.turretsBoostOn == false) //this checks if spaceship is stopped, i.e none of the minigames are played and their cooldowns are ran out
        {
            isShipStopped = true;
        }
        else
